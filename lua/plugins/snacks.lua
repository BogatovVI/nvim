...
return {
  {
      ...
      picker = {
        ...
        sources = {
          ...
          explorer = {
            ...
            win = {
              list = { keys = { ["/"] = "focus_input" } },
              input = { keys = { ["<Esc>"] = { "focus_list", mode = { "i", "n" } } } },
            },
          },
      ...
      dashboard = {
        ...
        preset = {
          keys = {
            ...
            { icon = "\u{f01c3} ", key = "e", desc = "File explorer       ", action = ":lua Snacks.explorer()" },
    ...
    keys = {
      ...
      { '<leader>ff', function() Snacks.picker.files() end, desc = "Find files by name" },
      { '<leader>fg', function() Snacks.picker.grep() end, desc = "Find text globally" },
      { '<leader>fb', function() Snacks.picker.buffers() end, desc = "Find in open buffers" },
      { '<leader>fh', function() Snacks.picker.help() end, desc = "Search Neovim help" },
      { '<leader>gs', function() Snacks.picker.git_status() end, desc = "Git project status" },
      { '<leader>sd', function() Snacks.picker.diagnostics() end, desc = "Search diagnostics" },
      { '<leader>ss', function() Snacks.picker.lsp_symbols() end, desc = "File structure (LSP)" },
